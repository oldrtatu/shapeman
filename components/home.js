	...
	<React.Fragment>
		...
		<div className="our_work">
			...
			<div className="first_card">
				...
				<div className="screenshot_container">
					<img className="screenshot" src={require('../images/lofty.png')} alt="Lofty Logistics" />
				</div>
			...
			<div className="second_card">
				...
				<div className="screenshot_container">
					<img className="screenshot1" src={require('../images/derma1.png')} alt="Lofty Logistics" />
					<img className="screenshot1" src={require('../images/derma2.png')} alt="Lofty Logistics" />
				</div>
			...
			<div className="first_card">
				...
				<div className="screenshot_container">
					<img className="screenshot1" src={require('../images/po1.png')} alt="Lofty Logistics" />
					<img className="screenshot1" src={require('../images/po2.png')} alt="Lofty Logistics" />
				</div>
				<div className="project_container">
					<div className="project_tech">DESIGN,IOS & ANDROID DEVELOPMENT</div>
		...
		<div className="services">
			...
			<div className="services_line">
				We build software that makes business more efficient and customer’s life easier
			</div>
			...
			<div className="slider">
				<div className="cards">
					<div className="testimonial_line">
						“I just wanted to share a quick note and let you know that you guys do a really good job. I’m
